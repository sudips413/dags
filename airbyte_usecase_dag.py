...
spark_submit_task = SparkSubmitOperator(
    task_id='airbyte_usecase_task',
    conn_id='spark',  # specify the connection id for your Spark cluster
    application="s3a://dn-apps-a6636dd9-f954-48ef-a17a-2f6c07f1da1c/scripts/spark/py/airbyte_usecase.py",  # specify the path to your Spark script
