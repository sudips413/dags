...
spark_submit_task = SparkSubmitOperator(
    task_id='spark_submit_task_2',
    conn_id='spark',  # specify the connection id for your Spark cluster
    application="s3a://dn-apps-49baf552-2b21-40ba-832f-2392a4226235/scripts/spark/py/test_python2.py",  # specify the path to your Spark script
    name='test_spark_dag',
    verbose=False,
    conf={
